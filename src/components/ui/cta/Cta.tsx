...
export const Cta = () => {
  ...
  return (
    <section className="relative py-12 px-6  bg-[url(/imgs/cta-mobile.png)] md:bg-[url(/imgs/banner-cta.jpg)] bg-cover text-white text-center rounded-xl shadow-lg mt-8">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 flex-wrap">
          <button
            ...
            className="px-6 py-2 w-[50%] md:w-[35%] lg:w-[30%] 2xl:w-[15%] flex items-center justify-center rounded-xl bg-gradient-to-r from-purple-600 to-purple-500 text-white font-bold hover:bg-gray-100 duration-200 active:scale-95 active:shadow-none transition-all"
          >
            {load ? (
              <>Ir a la tienda</>
            ) : (
